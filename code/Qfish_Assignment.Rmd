...
```
 ...
 I have decided to tidy up the visual aspect of the plot by logically grouping together some regions according to proximity.
...
Please note that the division of North, Central and South Qld is only based on personal choices and do not follow any recognized distinctions existing in the state of Qld. In this case the Region of North QLD comprises the sum of data for the regions Cairns, Townsville and Mackay, Central QLD comprises the sum of data for the regions Capricorn Coast, Gladstone, Bundaberg and Rainbow Beach, and South QLD comprises the sum of data for the regions Sunshine Coast and Bribie Isl.,Gold Coast and North Stradbroke Isl.
